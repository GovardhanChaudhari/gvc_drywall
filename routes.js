...
exports = module.exports = function(app, passport) {
  ...
  //admin > users
  app.get(app.config.urls.admin.userUrl, require('./views/admin/users/index').find);
  app.post(app.config.urls.admin.userUrl, require('./views/admin/users/index').create);
  app.get(app.config.urls.admin.userUrl+'/:id/', require('./views/admin/users/index').read);
  app.put(app.config.urls.admin.userUrl+'/:id/', require('./views/admin/users/index').update);
  app.put(app.config.urls.admin.userUrl+'/:id/password/', require('./views/admin/users/index').password);
  app.put(app.config.urls.admin.userUrl+'/:id/role-admin/', require('./views/admin/users/index').linkAdmin);
  app.delete(app.config.urls.admin.userUrl+'/:id/role-admin/', require('./views/admin/users/index').unlinkAdmin);
  app.put(app.config.urls.admin.userUrl+'/:id/role-account/', require('./views/admin/users/index').linkAccount);
  app.delete(app.config.urls.admin.userUrl+':id/role-account/', require('./views/admin/users/index').unlinkAccount);
  app.delete(app.config.urls.admin.userUrl+'/:id/', require('./views/admin/users/index').delete);
