...
exports.identity = function (req, res, next) {
    ...
    workflow.on('validate', function () {
        ...
        req.app.utility.gvcValidation.validateRequired("username", workflow, req);
        req.app.utility.gvcValidation.validateLettersAndNumbers("username", workflow, req, "Only use letters, numbers,-,_");

        req.app.utility.gvcValidation.validateRequired("email", workflow, req);
        req.app.utility.gvcValidation.validateEmail("email", workflow, req);
